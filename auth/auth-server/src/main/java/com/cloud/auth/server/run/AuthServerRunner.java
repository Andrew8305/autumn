package com.cloud.auth.server.run;
...
public class AuthServerRunner implements CommandLineRunner{
    ...
    private static final String REDIS_USER_PRI_KEY = "AU:AUTH:JWT:PRI";
    private static final String REDIS_USER_PUB_KEY = "AU:AUTH:JWT:PUB";
    private static final String REDIS_SERVICE_PRI_KEY = "AU:AUTH:CLIENT:PRI";
    private static final String REDIS_SERVICE_PUB_KEY = "AU:AUTH:CLIENT:PUB";
    @Autowired
